...
#
#                                     procesador_de_alarma.py
#           +-----------------------+-------------------------+------------------------+
#           |  Nombre del elemento  |     Responsabilidad     |      Propiedades       |
#           +-----------------------+-------------------------+------------------------+
#           |                       |                         |  - Se suscribe a los   |
#           |                       |                         |    eventos generados   |
#           |                       |  - Procesar las alarmas |    por el temporizador |
#           |     Procesador de     |    que se deberan       |                        |
#           |        Alarma         |    notificar.           |                                                             
#           |                       |                         |  - Notifica al monitor |
#           |                       |                         |    cuando un existe    |
#           |                       |                         |    una alarma.         |
...
#           +------------------------+--------------------------+-----------------------+
#           |      consume()         |           Ninguno        |  - Recibe las alarmas |
#           |                        |                          |    desde el distribui-|
#           |                        |                          |    dor de mensajes.   |
#           +------------------------+--------------------------+-----------------------+
#           |                        |  - ch: propio de Rabbit. |  - Detecta las larmas |
#           |                        |  - method: propio de     |    que deberan        |
#           |                        |     Rabbit.              |    notificarse        |
...
class ProcesadorAlarma:
    ...
    def consume(self):
        try:
            ...
            channel.basic_consume(self.callback, queue='medicamento')
